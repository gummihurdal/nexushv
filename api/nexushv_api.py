...
try:
    ...
    from modules.network_fabric import router as network_fabric_router
    ...
    app.include_router(network_fabric_router)
    log.info("Enterprise modules loaded: storage-fabric, predictive-ai, enterprise-auth, zero-touch, dr, drs, network-fabric")
except Exception as e:
